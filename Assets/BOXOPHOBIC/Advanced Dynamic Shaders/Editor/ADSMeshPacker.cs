...
public class ADSMeshPacker : EditorWindow
{
...
//    };
    ...
    string bannerText;
    string helpURL;
    static ADSMeshPacker Window;

    [MenuItem("BOXOPHOBIC/Advanced Dynamic Shaders/Mesh Packer")]
    public static void ShowWindow()
    {

        Window = GetWindow<ADSMeshPacker>(false, "ADS Mesh Packer", true);
    ...
    void OnEnable()
    {
        ...
        bannerText = "ADS Mesh Packer";
        helpURL = "https://docs.google.com/document/d/1PG_9bb0iiFGoi_yQd8IX0K3sMohuWqyq6_qa4AyVpFw/edit#heading=h.fmmkxyz2kgqy";
    ...
    void DrawPacking()
    {
        ...
        else if (meshPacking == MeshPackingEnum.Tree)
        {
            ...
            else if (treeType == TreeTypeEnum.SpeedTree7)
            {
                packingType = "Tree SpeedTree7";
