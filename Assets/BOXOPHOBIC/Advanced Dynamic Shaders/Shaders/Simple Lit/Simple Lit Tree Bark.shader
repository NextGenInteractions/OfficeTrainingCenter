...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Simple Lit/Tree Bark"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half MotionScale60_g2074 = ( ADS_GlobalScale * _MotionScale );
			half MotionSpeed62_g2074 = ( ADS_GlobalSpeed * _MotionSpeed );
			float mulTime90_g2074 = _Time.y * MotionSpeed62_g2074;
			float3 temp_output_95_0_g2074 = ( ( ase_worldPos * MotionScale60_g2074 ) + mulTime90_g2074 );
			half MotionlAmplitude58_g2074 = ( ADS_GlobalAmplitude * _MotionAmplitude );
			float3 temp_output_92_0_g2074 = ( sin( temp_output_95_0_g2074 ) * MotionlAmplitude58_g2074 );
			float3 temp_output_256_0_g2074 = mul( unity_WorldToObject, float4( ADS_GlobalDirection , 0.0 ) ).xyz;
			half3 MotionDirection59_g2074 = temp_output_256_0_g2074;
			half Packed_Trunk21634 = ( v.color.r * v.color.r );
			half ADS_TreeLeavesAffectMotion168_g2072 = 0.2;
			half ADS_TreeLeavesAmount157_g2072 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g2073 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g2073 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g2072 = saturate( ( ADS_TreeLeavesAmount157_g2072 - ( frac( ( localunity_ObjectToWorld0w1_g2073 + localunity_ObjectToWorld2w3_g2073 ) ) * ADS_GlobalLeavesVar ) ) );
			half LeavesAmountSimple172_g2072 = temp_output_142_0_g2072;
			float lerpResult156_g2072 = lerp( ADS_TreeLeavesAffectMotion168_g2072 , 1.0 , LeavesAmountSimple172_g2072);
			half MotionMask137_g2074 = ( Packed_Trunk21634 * lerpResult156_g2072 );
			float3 temp_output_94_0_g2074 = ( ( temp_output_92_0_g2074 * MotionDirection59_g2074 ) * MotionMask137_g2074 );
			float3 break231_g2074 = temp_output_94_0_g2074;
			float3 appendResult232_g2074 = (float3(break231_g2074.x , 0.0 , break231_g2074.z));
			half3 Motion_Trunk1749 = appendResult232_g2074;
			half MotionScale60_g2075 = ( ADS_GlobalScale * _MotionScale2 );
			half MotionSpeed62_g2075 = ( ADS_GlobalSpeed * _MotionSpeed2 );
			float mulTime90_g2075 = _Time.y * MotionSpeed62_g2075;
			float3 temp_output_95_0_g2075 = ( ( ase_worldPos * MotionScale60_g2075 ) + mulTime90_g2075 );
			half Packed_Variation1675 = v.color.a;
			half MotionVariation269_g2075 = ( _MotionVariation2 * Packed_Variation1675 );
			half MotionlAmplitude58_g2075 = ( ADS_GlobalAmplitude * _MotionAmplitude2 );
			float3 temp_output_92_0_g2075 = ( sin( ( temp_output_95_0_g2075 + MotionVariation269_g2075 ) ) * MotionlAmplitude58_g2075 );
			float3 lerpResult280_g2075 = lerp( ADS_GlobalDirection , float3(0,1,0) , _MotionVertical2);
			float3 temp_output_256_0_g2075 = mul( unity_WorldToObject, float4( lerpResult280_g2075 , 0.0 ) ).xyz;
			half3 MotionDirection59_g2075 = temp_output_256_0_g2075;
			half Packed_Branch1862 = v.color.g;
			half ADS_TreeLeavesAffectMotion168_g2070 = 0.2;
			half ADS_TreeLeavesAmount157_g2070 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g2071 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g2071 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g2070 = saturate( ( ADS_TreeLeavesAmount157_g2070 - ( frac( ( localunity_ObjectToWorld0w1_g2071 + localunity_ObjectToWorld2w3_g2071 ) ) * ADS_GlobalLeavesVar ) ) );
			half LeavesAmountSimple172_g2070 = temp_output_142_0_g2070;
			float lerpResult156_g2070 = lerp( ADS_TreeLeavesAffectMotion168_g2070 , 1.0 , LeavesAmountSimple172_g2070);
			half MotionMask137_g2075 = ( Packed_Branch1862 * lerpResult156_g2070 );
			float3 temp_output_94_0_g2075 = ( ( temp_output_92_0_g2075 * MotionDirection59_g2075 ) * MotionMask137_g2075 );
			half3 Motion_Branch1750 = temp_output_94_0_g2075;
			half localunity_ObjectToWorld0w1_g2078 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld1w2_g2078 = ( unity_ObjectToWorld[1].w );
			half localunity_ObjectToWorld2w3_g2078 = ( unity_ObjectToWorld[2].w );
			float3 appendResult6_g2078 = (float3(localunity_ObjectToWorld0w1_g2078 , localunity_ObjectToWorld1w2_g2078 , localunity_ObjectToWorld2w3_g2078));
			float2 panner73_g2076 = ( _Time.y * ( ADS_TurbulenceSpeed * (-ADS_GlobalDirection).xz ) + ( (appendResult6_g2078).xz * ADS_TurbulenceScale ));
			float lerpResult136_g2076 = lerp( 1.0 , saturate( pow( abs( tex2Dlod( ADS_TurbulenceTex, float4( panner73_g2076, 0, 0.0) ).r ) , ADS_TurbulenceContrast ) ) , _GlobalTurbulence);
			float ifLocalVar94_g2076 = 0;
			UNITY_BRANCH 
			if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) > 0.0001 )
				ifLocalVar94_g2076 = lerpResult136_g2076;
			else if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) < 0.0001 )
				ifLocalVar94_g2076 = 1.0;
			half Motion_Turbulence2221 = ifLocalVar94_g2076;
...
/*ASEBEGIN
Version=16309
1927;29;1906;1014;2956.127;-569.8995;2.918111;True;False
...
Node;AmplifyShaderEditor.FunctionNode;2227;0,2432;Float;False;ADS Leaves Amount;-1;;2072;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
Node;AmplifyShaderEditor.FunctionNode;2228;1280,2432;Float;False;ADS Leaves Amount;-1;;2070;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.FunctionNode;2016;640,1920;Float;False;ADS Motion Custom;58;;2074;157ee7880d81d9e4ab5582c2b22b9a68;8,225,1,278,0,228,0,292,1,254,0,262,0,252,0,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2220;-1280,2496;Float;False;ADS Global Turbulence;32;;2076;047eb809542f42d40b4b5066e22cee72;0;0;1;FLOAT;85
...
Node;AmplifyShaderEditor.FunctionNode;2114;-1280,1152;Float;False;const;-1;;2081;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;2177;4096,-256;Float;False;Property;_EnableBase;Enable Base;18;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Off;Base;Create;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;2224;1024,2432;Float;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1469;-768,-3360;Half;False;Property;_SETTINGSS;[ SETTINGSS ];31;0;Create;True;0;0;True;1;BCategory(Settings);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2018;3264,1920;Float;False;ADS Motion Custom;58;;2084;157ee7880d81d9e4ab5582c2b22b9a68;8,225,0,278,1,228,1,292,1,254,0,262,0,252,3,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2115;-384,1152;Float;False;const;-1;;2085;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;2180;4096,320;Float;False;Property;_EnableBase;Enable Base;19;0;Create;True;0;0;False;0;0;0;0;False;;Toggle;2;Off;Base;Create;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2116;512,1152;Float;False;const;-1;;2082;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;2176;4096,512;Float;False;Property;_EnableBase;Enable Base;19;0;Create;True;0;0;False;0;0;0;0;False;;Toggle;2;Off;Base;Create;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1938;0,-2688;Float;False;Internal Unity Props;68;;2083;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-128,-2176;Float;False;True;2;Float;ADSShaderGUI;300;0;Lambert;BOXOPHOBIC/Advanced Dynamic Shaders/Simple Lit/Tree Bark;False;False;False;False;False;True;True;True;True;False;True;False;False;True;True;False;True;False;False;False;True;Back;0;False;925;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0;True;True;0;True;Opaque;;Geometry;All;True;True;True;False;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;True;550;10;True;553;0;1;False;550;10;False;553;0;True;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;300;Utils/ADS Fallback;-1;-1;-1;-1;0;False;0;0;False;743;-1;0;True;862;3;Include;../../../Utils/CGIncludes/VS_indirect.cginc;False;;Pragma;instancing_options procedural:setup;False;;Pragma;multi_compile GPU_FRUSTUM_ON __;False;;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;2024;1;2227;148
WireConnection;2029;0;1811;0
WireConnection;2029;1;2228;148
...
ASEEND*/
//CHKSM=CFBEA6521509A2972CD184E91CA20089E457D25C