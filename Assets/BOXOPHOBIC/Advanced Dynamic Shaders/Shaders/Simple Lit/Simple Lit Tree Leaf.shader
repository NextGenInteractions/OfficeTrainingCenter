...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Simple Lit/Tree Leaf"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half MotionScale60_g1885 = ( ADS_GlobalScale * _MotionScale );
			half MotionSpeed62_g1885 = ( ADS_GlobalSpeed * _MotionSpeed );
			float mulTime90_g1885 = _Time.y * MotionSpeed62_g1885;
			float3 temp_output_95_0_g1885 = ( ( ase_worldPos * MotionScale60_g1885 ) + mulTime90_g1885 );
			half MotionlAmplitude58_g1885 = ( ADS_GlobalAmplitude * _MotionAmplitude );
			float3 temp_output_92_0_g1885 = ( sin( temp_output_95_0_g1885 ) * MotionlAmplitude58_g1885 );
			float3 temp_output_256_0_g1885 = mul( unity_WorldToObject, float4( ADS_GlobalDirection , 0.0 ) ).xyz;
			half3 MotionDirection59_g1885 = temp_output_256_0_g1885;
			...
			half MotionMask137_g1885 = ( Packed_Trunk21809 * lerpResult156_g1878 );
			float3 temp_output_94_0_g1885 = ( ( temp_output_92_0_g1885 * MotionDirection59_g1885 ) * MotionMask137_g1885 );
			float3 break231_g1885 = temp_output_94_0_g1885;
			float3 appendResult232_g1885 = (float3(break231_g1885.x , 0.0 , break231_g1885.z));
			half3 Motion_Trunk1749 = appendResult232_g1885;
			half MotionScale60_g1884 = ( ADS_GlobalScale * _MotionScale2 );
			half MotionSpeed62_g1884 = ( ADS_GlobalSpeed * _MotionSpeed2 );
			float mulTime90_g1884 = _Time.y * MotionSpeed62_g1884;
			float3 temp_output_95_0_g1884 = ( ( ase_worldPos * MotionScale60_g1884 ) + mulTime90_g1884 );
			half Packed_Variation1815 = v.color.a;
			half MotionVariation269_g1884 = ( _MotionVariation2 * Packed_Variation1815 );
			half MotionlAmplitude58_g1884 = ( ADS_GlobalAmplitude * _MotionAmplitude2 );
			float3 temp_output_92_0_g1884 = ( sin( ( temp_output_95_0_g1884 + MotionVariation269_g1884 ) ) * MotionlAmplitude58_g1884 );
			float3 lerpResult280_g1884 = lerp( ADS_GlobalDirection , float3(0,1,0) , _MotionVertical2);
			float3 temp_output_256_0_g1884 = mul( unity_WorldToObject, float4( lerpResult280_g1884 , 0.0 ) ).xyz;
			half3 MotionDirection59_g1884 = temp_output_256_0_g1884;
			...
			half MotionMask137_g1884 = ( Packed_Branch1830 * lerpResult156_g1876 );
			float3 temp_output_94_0_g1884 = ( ( temp_output_92_0_g1884 * MotionDirection59_g1884 ) * MotionMask137_g1884 );
			half3 Motion_Branch1750 = temp_output_94_0_g1884;
			float3 ase_vertex3Pos = v.vertex.xyz;
			half MotionFlutterScale60_g1886 = ( ADS_GlobalScale * _MotionScale3 );
			half MotionFlutterSpeed62_g1886 = ( ADS_GlobalSpeed * _MotionSpeed3 );
			float mulTime90_g1886 = _Time.y * MotionFlutterSpeed62_g1886;
			half MotionlFlutterAmplitude58_g1886 = ( ADS_GlobalAmplitude * _MotionAmplitude3 );
			half Packed_Leaf1819 = v.color.b;
			half MotionMask137_g1886 = Packed_Leaf1819;
			float3 ase_vertexNormal = v.normal.xyz;
			half3 Motion_Leaf1751 = ( ( ( sin( ( ( ase_vertex3Pos * MotionFlutterScale60_g1886 ) + mulTime90_g1886 ) ) * MotionlFlutterAmplitude58_g1886 ) * MotionMask137_g1886 ) * ase_vertexNormal );
			half localunity_ObjectToWorld0w1_g1906 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld1w2_g1906 = ( unity_ObjectToWorld[1].w );
			half localunity_ObjectToWorld2w3_g1906 = ( unity_ObjectToWorld[2].w );
			float3 appendResult6_g1906 = (float3(localunity_ObjectToWorld0w1_g1906 , localunity_ObjectToWorld1w2_g1906 , localunity_ObjectToWorld2w3_g1906));
			float2 panner73_g1904 = ( _Time.y * ( ADS_TurbulenceSpeed * (-ADS_GlobalDirection).xz ) + ( (appendResult6_g1906).xz * ADS_TurbulenceScale ));
			float lerpResult136_g1904 = lerp( 1.0 , saturate( pow( abs( tex2Dlod( ADS_TurbulenceTex, float4( panner73_g1904, 0, 0.0) ).r ) , ADS_TurbulenceContrast ) ) , _GlobalTurbulence);
			float ifLocalVar94_g1904 = 0;
			UNITY_BRANCH 
			if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) > 0.0001 )
				ifLocalVar94_g1904 = lerpResult136_g1904;
			else if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) < 0.0001 )
				ifLocalVar94_g1904 = 1.0;
			half Motion_Turbulence1921 = ifLocalVar94_g1904;
			...
			o.vertexToFrag1907 = lerpResult168_g1899;
		}

		void surf( Input i , inout SurfaceOutput o )
		{
			float2 uv_NormalTex607 = i.uv_texcoord;
			float3 temp_output_13_0_g1912 = UnpackScaleNormal( tex2D( _NormalTex, uv_NormalTex607 ), _NormalScale );
			float3 break17_g1912 = temp_output_13_0_g1912;
			float switchResult12_g1912 = (((i.ASEVFace>0)?(break17_g1912.z):(-break17_g1912.z)));
			float3 appendResult18_g1912 = (float3(break17_g1912.x , break17_g1912.y , switchResult12_g1912));
			float3 lerpResult20_g1912 = lerp( temp_output_13_0_g1912 , appendResult18_g1912 , _NormalInvertOnBackface);
			half3 Main_NormalTex620 = lerpResult20_g1912;
			...
			float temp_output_152_0_g1910 = i.uv_tex4coord.w;
			half ADS_TreeLeavesAmount157_g1910 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g1911 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g1911 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g1910 = saturate( ( ADS_TreeLeavesAmount157_g1910 - ( frac( ( localunity_ObjectToWorld0w1_g1911 + localunity_ObjectToWorld2w3_g1911 ) ) * ADS_GlobalLeavesVar ) ) );
			float lerpResult175_g1910 = lerp( 0.0 , ceil( ( temp_output_152_0_g1910 - temp_output_142_0_g1910 ) ) , step( temp_output_152_0_g1910 , 3.0 ));
			half Opacity1306 = saturate( ( Main_AlbedoTex_A616 - lerpResult175_g1910 ) );
...
/*ASEBEGIN
Version=16309
1927;29;1906;1014;-268.7723;1324.883;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1930;896,1280;Float;False;ADS Leaves Amount;-1;;1876;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.FunctionNode;1919;2560,768;Float;False;ADS Motion Flutter;-1;;1886;87d8028e5f83178498a65cfa9f0e9ace;0;4;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;136;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1859;256,768;Float;False;ADS Motion Custom;29;;1885;157ee7880d81d9e4ab5582c2b22b9a68;8,225,1,278,0,228,0,292,1,254,0,262,0,252,0,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1857;1536,768;Float;False;ADS Motion Custom;29;;1884;157ee7880d81d9e4ab5582c2b22b9a68;8,225,0,278,1,228,1,292,1,254,0,262,0,252,3,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1905;-1280,1920;Float;False;1815;Packed_Variation;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1901;0,-128;Float;False;const;-1;;1909;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1920;-1280,1344;Float;False;ADS Global Turbulence;18;;1904;047eb809542f42d40b4b5066e22cee72;0;0;1;FLOAT;85
...
Node;AmplifyShaderEditor.FunctionNode;1906;-1024,1920;Float;False;ADS Global Settings;22;;1899;0fe83146627632b4981f5a0aa1b63801;0;1;171;FLOAT;0;False;3;COLOR;85;COLOR;165;FLOAT;157
...
Node;AmplifyShaderEditor.FunctionNode;1931;-1008,0;Float;False;ADS Leaves Amount;-1;;1910;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.RangedFloatNode;1932;720,-704;Half;False;Property;_NormalInvertOnBackface;Render Backface;5;1;[Enum];Create;False;2;Mirrored Normals;0;Flipped Normals;1;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1915;976,-896;Float;False;ADS Normal Backface;-1;;1912;4f53bc25e6d8da34db70401bcf363a2a;0;2;13;FLOAT3;0,0,0;False;30;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1846;0,-2560;Float;False;Internal Unity Props;57;;1914;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1902;895.382,-127.3066;Float;False;const;-1;;1913;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=889FBE40485C07CB7CDD7EEBF9C9708D7F2D3CD7