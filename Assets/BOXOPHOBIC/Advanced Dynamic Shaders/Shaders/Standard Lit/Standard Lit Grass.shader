...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Grass"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half MotionVariation269_g1588 = ( _MotionVariation * Packed_Variation1239 );
			...
			float3 lerpResult293_g1588 = lerp( temp_output_92_0_g1588 , temp_output_160_0_g1588 , Motion_Turbulence1240);
			...
			half MotionMask137_g1588 = Packed_Grass1241;
			...
			half3 Motion_Grass1257 = appendResult232_g1588;
			...
			half3 Global_Size1209 = ( ( lerpResult156_g1589 * _GlobalSize ) * ase_vertex3Pos );
			...
			o.vertexToFrag1205 = lerpResult150_g1589;
		}
...
/*ASEBEGIN
Version=16309
1927;29;1906;1014;718.7548;1250.464;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1204;-1280,640;Float;False;ADS Global Settings;18;;1589;0fe83146627632b4981f5a0aa1b63801;0;1;171;FLOAT;0;False;3;COLOR;85;COLOR;165;FLOAT;157
...
Node;AmplifyShaderEditor.RangedFloatNode;1265;320,-704;Half;False;Property;_NormalInvertOnBackface;Render Backface;4;1;[Enum];Create;False;2;Mirrored Normals;0;Flipped Normals;1;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1230;592,-896;Float;False;ADS Normal Backface;-1;;1594;4f53bc25e6d8da34db70401bcf363a2a;0;2;13;FLOAT3;0,0,0;False;30;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=C5ED933FD0CE21E52FB27717FA96BAB1B5B808A4