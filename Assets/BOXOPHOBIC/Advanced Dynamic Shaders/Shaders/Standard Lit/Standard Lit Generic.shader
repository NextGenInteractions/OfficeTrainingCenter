	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 ase_vertex3Pos = v.vertex.xyz;
				...
				float3 staticSwitch261_g1856 = ase_worldPos;
			#elif defined(_MOTIONSPACE_LOCAL)
				float3 staticSwitch261_g1856 = ase_vertex3Pos;
			#else
				float3 staticSwitch261_g1856 = ase_worldPos;
			#endif
			half MotionScale60_g1856 = ( ADS_GlobalScale * _MotionScale );
			half MotionSpeed62_g1856 = ( ADS_GlobalSpeed * _MotionSpeed );
			float mulTime90_g1856 = _Time.y * MotionSpeed62_g1856;
			float3 temp_output_95_0_g1856 = ( ( staticSwitch261_g1856 * MotionScale60_g1856 ) + mulTime90_g1856 );
			half Packed_Variation1138 = v.color.a;
			half MotionVariation269_g1856 = ( _MotionVariation * Packed_Variation1138 );
			half MotionlAmplitude58_g1856 = ( ADS_GlobalAmplitude * _MotionAmplitude );
			float3 temp_output_92_0_g1856 = ( sin( ( temp_output_95_0_g1856 + MotionVariation269_g1856 ) ) * MotionlAmplitude58_g1856 );
			float3 temp_output_160_0_g1856 = ( temp_output_92_0_g1856 + MotionlAmplitude58_g1856 + MotionlAmplitude58_g1856 );
			half localunity_ObjectToWorld0w1_g1850 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld1w2_g1850 = ( unity_ObjectToWorld[1].w );
			half localunity_ObjectToWorld2w3_g1850 = ( unity_ObjectToWorld[2].w );
			float3 appendResult6_g1850 = (float3(localunity_ObjectToWorld0w1_g1850 , localunity_ObjectToWorld1w2_g1850 , localunity_ObjectToWorld2w3_g1850));
			float2 panner73_g1848 = ( _Time.y * ( ADS_TurbulenceSpeed * (-ADS_GlobalDirection).xz ) + ( (appendResult6_g1850).xz * ADS_TurbulenceScale ));
			float lerpResult136_g1848 = lerp( 1.0 , saturate( pow( abs( tex2Dlod( ADS_TurbulenceTex, float4( panner73_g1848, 0, 0.0) ).r ) , ADS_TurbulenceContrast ) ) , _GlobalTurbulence);
			float ifLocalVar94_g1848 = 0;
			UNITY_BRANCH 
			if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) > 0.0001 )
				ifLocalVar94_g1848 = lerpResult136_g1848;
			else if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) < 0.0001 )
				ifLocalVar94_g1848 = 1.0;
			half Motion_Turbulence1162 = ifLocalVar94_g1848;
			float3 lerpResult293_g1856 = lerp( temp_output_92_0_g1856 , temp_output_160_0_g1856 , Motion_Turbulence1162);
			float3 temp_output_256_0_g1856 = mul( unity_WorldToObject, float4( ADS_GlobalDirection , 0.0 ) ).xyz;
			#if defined(_MOTIONSPACE_WORLD)
				float3 staticSwitch257_g1856 = temp_output_256_0_g1856;
			#elif defined(_MOTIONSPACE_LOCAL)
				float3 staticSwitch257_g1856 = _LocalDirection;
			#else
				float3 staticSwitch257_g1856 = temp_output_256_0_g1856;
			#endif
			half3 MotionDirection59_g1856 = staticSwitch257_g1856;
			float temp_output_25_0_g1855 = _MaskAxis;
			float lerpResult24_g1855 = lerp( v.texcoord3.x , v.texcoord3.y , saturate( temp_output_25_0_g1855 ));
			float lerpResult21_g1855 = lerp( lerpResult24_g1855 , v.texcoord3.z , step( 2.0 , temp_output_25_0_g1855 ));
			half THREE27_g1855 = lerpResult21_g1855;
			float temp_output_7_0_g1854 = _MaskMin;
			float lerpResult42_g1853 = lerp( v.color.r , saturate( ( ( THREE27_g1855 - temp_output_7_0_g1854 ) / ( _MaskMax - temp_output_7_0_g1854 ) ) ) , _MaskType);
			half Packed_Mask1141 = lerpResult42_g1853;
			half MotionMask137_g1856 = Packed_Mask1141;
			float3 temp_output_94_0_g1856 = ( ( lerpResult293_g1856 * MotionDirection59_g1856 ) * MotionMask137_g1856 );
			half3 Motion_Generic1148 = temp_output_94_0_g1856;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_13_0_g1857 = UnpackScaleNormal( tex2D( _NormalTex, Main_UVs587 ), _NormalScale );
			float3 break17_g1857 = temp_output_13_0_g1857;
			float switchResult12_g1857 = (((i.ASEVFace>0)?(break17_g1857.z):(-break17_g1857.z)));
			float3 appendResult18_g1857 = (float3(break17_g1857.x , break17_g1857.y , switchResult12_g1857));
			float3 lerpResult20_g1857 = lerp( temp_output_13_0_g1857 , appendResult18_g1857 , _NormalInvertOnBackface);
			half3 Main_NormalTex620 = lerpResult20_g1857;
...
/*ASEBEGIN
Version=16309
1927;29;1906;1014;-1098.734;1320.745;1;True;False
Node;AmplifyShaderEditor.Vector4Node;563;-1280,-672;Half;False;Property;_UVZero;Main UVs;16;0;Create;False;0;0;False;1;Space(10);1,1,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1137;-1280,-128;Float;False;ADS Mask Generic;36;;1853;2cfc3815568565c4585aebb38bd7a29b;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;575;-624,-896;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;1161;-1280,192;Float;False;ADS Global Turbulence;18;;1848;047eb809542f42d40b4b5066e22cee72;0;0;1;FLOAT;85
...
Node;AmplifyShaderEditor.FunctionNode;1159;128,-128;Float;False;ADS Motion Custom;23;;1856;157ee7880d81d9e4ab5582c2b22b9a68;8,225,0,278,1,228,1,292,2,254,2,262,2,252,0,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;409;768,-896;Half;False;Property;_Color;Main Color;9;0;Create;False;0;0;False;0;1,1,1,1;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;18;80,-896;Float;True;Property;_AlbedoTex;Main Albedo;10;1;[NoScaleOffset];Create;False;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1165;1856,-704;Half;False;Property;_NormalInvertOnBackface;Render Backface;5;1;[Enum];Create;False;2;Mirrored Normals;0;Flipped Normals;1;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;294;3712,-624;Half;False;Property;_Smoothness;Main Smoothness;15;0;Create;False;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1134;2128,-896;Float;False;ADS Normal Backface;-1;;1857;4f53bc25e6d8da34db70401bcf363a2a;0;2;13;FLOAT3;0,0,0;False;30;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1133;-896,-1792;Float;False;const;-1;;1858;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1127;0,-2944;Float;False;Internal Unity Props;47;;1859;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;862;-448,-2944;Half;False;Property;_Cutoff;Cutout;7;0;Create;False;3;Off;0;Front;1;Back;2;0;True;0;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1105;-928,-3616;Half;False;Property;_SETTINGSS;[ SETTINGSS ];17;0;Create;True;0;0;True;1;BCategory(Settings);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1104;-1088,-3616;Half;False;Property;_MAINN;[ MAINN ];8;0;Create;True;0;0;True;1;BCategory(Main);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1103;-1280,-3520;Half;False;Property;_RenderTypee;# _RenderTypee;6;0;Create;True;0;0;True;1;BInteractive(_RenderType, 1);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;0,-2176;Float;False;True;2;Float;ADSShaderGUI;300;0;Standard;BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Generic;False;False;False;False;False;False;True;True;True;False;True;False;False;True;True;False;False;False;False;False;True;Off;0;True;925;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0;True;True;0;True;Opaque;;Geometry;All;True;True;True;False;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;1;5;True;550;10;True;553;0;1;False;550;10;False;553;0;True;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;300;Utils/ADS Fallback;-1;-1;-1;-1;0;False;0;0;True;743;-1;0;True;862;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=65595D4BFF9870A2C793B71DB6B11B4287958128