...
Shader "BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Tree Bark"
{
	...
	SubShader
	{
		...
		#pragma surface surf Standard keepalpha addshadow fullforwardshadows novertexlights nolightmap  nodynlightmap nodirlightmap nometa vertex:vertexDataFunc 
		#undef TRANSFORM_TEX
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half MotionScale60_g2012 = ( ADS_GlobalScale * _MotionScale );
			half MotionSpeed62_g2012 = ( ADS_GlobalSpeed * _MotionSpeed );
			float mulTime90_g2012 = _Time.y * MotionSpeed62_g2012;
			float3 temp_output_95_0_g2012 = ( ( ase_worldPos * MotionScale60_g2012 ) + mulTime90_g2012 );
			half MotionlAmplitude58_g2012 = ( ADS_GlobalAmplitude * _MotionAmplitude );
			float3 temp_output_92_0_g2012 = ( sin( temp_output_95_0_g2012 ) * MotionlAmplitude58_g2012 );
			float3 temp_output_256_0_g2012 = mul( unity_WorldToObject, float4( ADS_GlobalDirection , 0.0 ) ).xyz;
			half3 MotionDirection59_g2012 = temp_output_256_0_g2012;
			half Packed_Trunk21634 = ( v.color.r * v.color.r );
			half ADS_TreeLeavesAffectMotion168_g2007 = 0.2;
			half ADS_TreeLeavesAmount157_g2007 = ADS_GlobalLeavesAmount;
			half localunity_ObjectToWorld0w1_g2008 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld2w3_g2008 = ( unity_ObjectToWorld[2].w );
			float temp_output_142_0_g2007 = saturate( ( ADS_TreeLeavesAmount157_g2007 - ( frac( ( localunity_ObjectToWorld0w1_g2008 + localunity_ObjectToWorld2w3_g2008 ) ) * ADS_GlobalLeavesVar ) ) );
			half LeavesAmountSimple172_g2007 = temp_output_142_0_g2007;
			float lerpResult156_g2007 = lerp( ADS_TreeLeavesAffectMotion168_g2007 , 1.0 , LeavesAmountSimple172_g2007);
			half MotionMask137_g2012 = ( Packed_Trunk21634 * lerpResult156_g2007 );
			float3 temp_output_94_0_g2012 = ( ( temp_output_92_0_g2012 * MotionDirection59_g2012 ) * MotionMask137_g2012 );
			float3 break231_g2012 = temp_output_94_0_g2012;
			float3 appendResult232_g2012 = (float3(break231_g2012.x , 0.0 , break231_g2012.z));
			half3 Motion_Trunk1749 = appendResult232_g2012;
			half MotionScale60_g2013 = ( ADS_GlobalScale * _MotionScale2 );
			half MotionSpeed62_g2013 = ( ADS_GlobalSpeed * _MotionSpeed2 );
			float mulTime90_g2013 = _Time.y * MotionSpeed62_g2013;
			float3 temp_output_95_0_g2013 = ( ( ase_worldPos * MotionScale60_g2013 ) + mulTime90_g2013 );
			half Packed_Variation1675 = v.color.a;
			half MotionVariation269_g2013 = ( _MotionVariation2 * Packed_Variation1675 );
			half MotionlAmplitude58_g2013 = ( ADS_GlobalAmplitude * _MotionAmplitude2 );
			float3 temp_output_92_0_g2013 = ( sin( ( temp_output_95_0_g2013 + MotionVariation269_g2013 ) ) * MotionlAmplitude58_g2013 );
			float3 lerpResult280_g2013 = lerp( ADS_GlobalDirection , float3(0,1,0) , _MotionVertical2);
			float3 temp_output_256_0_g2013 = mul( unity_WorldToObject, float4( lerpResult280_g2013 , 0.0 ) ).xyz;
			half3 MotionDirection59_g2013 = temp_output_256_0_g2013;
			...
			half MotionMask137_g2013 = ( Packed_Branch1862 * lerpResult156_g2009 );
			float3 temp_output_94_0_g2013 = ( ( temp_output_92_0_g2013 * MotionDirection59_g2013 ) * MotionMask137_g2013 );
			half3 Motion_Branch1750 = temp_output_94_0_g2013;
			half localunity_ObjectToWorld0w1_g2016 = ( unity_ObjectToWorld[0].w );
			half localunity_ObjectToWorld1w2_g2016 = ( unity_ObjectToWorld[1].w );
			half localunity_ObjectToWorld2w3_g2016 = ( unity_ObjectToWorld[2].w );
			float3 appendResult6_g2016 = (float3(localunity_ObjectToWorld0w1_g2016 , localunity_ObjectToWorld1w2_g2016 , localunity_ObjectToWorld2w3_g2016));
			float2 panner73_g2014 = ( _Time.y * ( ADS_TurbulenceSpeed * (-ADS_GlobalDirection).xz ) + ( (appendResult6_g2016).xz * ADS_TurbulenceScale ));
			float lerpResult136_g2014 = lerp( 1.0 , saturate( pow( abs( tex2Dlod( ADS_TurbulenceTex, float4( panner73_g2014, 0, 0.0) ).r ) , ADS_TurbulenceContrast ) ) , _GlobalTurbulence);
			float ifLocalVar94_g2014 = 0;
			UNITY_BRANCH 
			if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) > 0.0001 )
				ifLocalVar94_g2014 = lerpResult136_g2014;
			else if( ( ADS_TurbulenceTex_ON * _GlobalTurbulence ) < 0.0001 )
				ifLocalVar94_g2014 = 1.0;
			half Motion_Turbulence2199 = ifLocalVar94_g2014;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_7_0_g1875 = 0.0;
			...
			float temp_output_84_0_g1959 = ( ( Packed_Trunk1813 - temp_output_7_0_g1875 ) / ( ( _BaseBlendAmount * lerpResult2138 ) - temp_output_7_0_g1875 ) );
...
/*ASEBEGIN
Version=16309
1927;29;1906;1014;750.71;-1405.81;1.755066;True;False
Node;AmplifyShaderEditor.Vector4Node;563;-1280,-800;Half;False;Property;_UVZero;Trunk UVs;16;0;Create;False;0;0;False;1;Space(10);1,1,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;1480;-1280,-32;Half;False;Property;_UVZero3;Base UVs;27;0;Create;False;0;0;False;1;Space(10);1,1,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1826;-256,-704;Half;False;Property;_TrunkVariation;Trunk Variation;15;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1822;384,144;Half;False;Property;_BaseBlendVariation;Base Blend Variation;29;0;Create;True;0;0;False;1;;0.1;0;0.0001;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2049;-384,128;Float;True;Property;_SurfaceTex3;Base Surface;24;1;[NoScaleOffset];Create;False;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;1813;-1024,1920;Half;False;Packed_Trunk;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1426;384,-96;Half;False;Property;_BaseBlendAmount;Base Blend Amount;28;0;Create;True;0;0;False;1;;0.1;0;0.0001;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2116;512,1152;Float;False;const;-1;;1877;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2052;512,1472;Half;False;Property;_Occlusion3;Base Occlusion (G);26;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1488;-768,0;Half;False;Property;_NormalScale3;Base Normal Scale;22;0;Create;False;0;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1494;1408,-64;Float;False;616;Main_AlbedoTex_Alpha;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1425;1408,-256;Float;False;Remap To 0-1;-1;;1875;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2053;512,1280;Float;False;2050;Base_SurfaceTex_G;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2115;-384,1152;Float;False;const;-1;;1876;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1419;1408,128;Float;False;Property;_BaseBlendContrast;Base Blend Contrast;30;0;Create;True;0;0;False;0;0.9;0;0;0.999;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1532;-1280,384;Half;False;Property;_Color3;Base Color;20;0;Create;False;0;0;False;0;1,1,1,1;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;750;-640,464;Half;False;Property;_Smoothness3;Base Smoothness (A);25;0;Create;False;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1415;-384,-256;Float;True;Property;_AlbedoTex3;Base Albedo;21;1;[NoScaleOffset];Create;False;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1486;-384,-64;Float;True;Property;_NormalTex3;Base Normal;23;2;[NoScaleOffset];[Normal];Create;False;0;0;False;0;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;2205;0,2432;Float;False;ADS Leaves Amount;-1;;2007;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
Node;AmplifyShaderEditor.FunctionNode;2206;1280,2432;Float;False;ADS Leaves Amount;-1;;2009;ee8761bdf5e2c1e4b8e0ff49e8488b33;0;1;152;FLOAT;0;False;3;FLOAT;154;FLOAT;148;FLOAT;167
...
Node;AmplifyShaderEditor.RangedFloatNode;1732;1280,2160;Float;False;Property;_MotionVariation2;Branch Motion Variation;48;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1561;1280,2080;Float;False;Property;_MotionScale2;Branch Motion Scale;47;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1556;0,2000;Float;False;Property;_MotionSpeed;Trunk Motion Speed;41;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1733;1536,2160;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2139;1664,2560;Float;False;Property;_MotionVertical2;Branch Motion Vertical;49;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1563;1280,1920;Float;False;Property;_MotionAmplitude2;Branch Motion Amplitude;45;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2029;1728,2320;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1555;0,1920;Float;False;Property;_MotionAmplitude;Trunk Motion Amplitude;40;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1562;1280,2000;Float;False;Property;_MotionSpeed2;Branch Motion Speed;46;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1557;0,2080;Float;False;Property;_MotionScale;Trunk Motion Scale;42;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2193;2960,368;Half;False;Property;_BaseBlendNormals;Base Blend Normals;31;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2016;640,1920;Float;False;ADS Motion Custom;59;;2012;157ee7880d81d9e4ab5582c2b22b9a68;8,225,1,278,0,228,0,292,1,254,0,262,0,252,0,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2198;-1280,2496;Float;False;ADS Global Turbulence;33;;2014;047eb809542f42d40b4b5066e22cee72;0;0;1;FLOAT;85
Node;AmplifyShaderEditor.LerpOp;2059;3008,512;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2114;-1280,1152;Float;False;const;-1;;2019;5b64729fb717c5f49a1bc2dab81d5e1c;1,3,1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1309;-1280,1472;Half;False;Property;_VertexOcclusion;Vertex Occlusion;37;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2201;3968,2208;Float;False;2199;Motion_Turbulence;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;2177;4224,-256;Float;False;Property;_EnableBase;Enable Base;18;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Off;Base;Create;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1932;1936,-2688;Half;False;Property;_Internal_SetByScript;Internal_SetByScript;84;1;[HideInInspector];Create;True;0;0;True;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;550;-1280,-2688;Half;False;Property;_SrcBlend;_SrcBlend;85;1;[HideInInspector];Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2200;0,2176;Float;False;2199;Motion_Turbulence;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2048;1664,-2688;Half;False;Property;_Internal_DebugVariation;Internal_DebugVariation;83;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1739;2624,2160;Float;False;Property;_MotionVariation3;Leaf Motion Variation;55;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1935;928,-2688;Half;False;Property;_Internal_LitStandard;Internal_LitStandard;79;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1934;672,-2688;Half;False;Property;_Internal_TypeTreeBark;Internal_TypeTreeBark;80;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1714;2624,2080;Float;False;Property;_MotionScale3;Leaf Motion Scale;54;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2018;3264,1920;Float;False;ADS Motion Custom;59;;2021;157ee7880d81d9e4ab5582c2b22b9a68;8,225,0,278,1,228,1,292,1,254,0,262,0,252,3,260,0;9;220;FLOAT;0;False;221;FLOAT;0;False;222;FLOAT;0;False;218;FLOAT;0;False;287;FLOAT;0;False;136;FLOAT;0;False;248;FLOAT3;0,0,0;False;279;FLOAT;0;False;247;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1799;-1088,-3264;Half;False;Property;_BlendingBasee;# BlendingBasee;19;0;Create;True;0;0;True;1;BInteractive(_ENABLEBASE_ON);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2194;256,-2688;Half;False;Property;_Internal_Version;Internal_Version;0;1;[HideInInspector];Create;True;0;0;True;0;220;1;220;220;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2047;480,-2688;Half;False;Property;_Internal_ADS;Internal_ADS;68;1;[HideInInspector];Create;True;0;0;True;0;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;2202;1024,2432;Float;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1931;1408,-2688;Half;False;Property;_Internal_DebugMask2;Internal_DebugMask2;82;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1469;-768,-3360;Half;False;Property;_SETTINGSS;[ SETTINGSS ];32;0;Create;True;0;0;True;1;BCategory(Settings);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1471;128,-3360;Half;False;Property;_ADVANCEDD;[ ADVANCEDD ];57;0;Create;True;0;0;True;1;BCategory(Advanced);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;553;-1120,-2688;Half;False;Property;_DstBlend;_DstBlend;86;1;[HideInInspector];Create;True;0;0;False;0;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1938;0,-2688;Float;False;Internal Unity Props;69;;2020;b286e6ef621b64a4fb35da1e13fa143f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1708;-976,-3168;Half;False;Property;_BranchMotionParameters;!!! Branch Motion Parameters !!!;44;0;Create;True;0;0;True;1;BMessage(Info, The Branch Motion Parameters will be overridden by the ADS Materials Helper Component, _Internal_SetByScript, 1, 0, 10);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2196;-352,-3168;Half;False;Property;_BatchingInfo;!!! BatchingInfo;58;0;Create;True;0;0;True;1;BMessage(Info, Batching is not currently supported Please use GPU Instancing instead for better performance, 0, 0);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;654;-1280,-1952;Float;False;2071;OUT_SMOOTHNESS;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1715;2624,2000;Float;False;Property;_MotionSpeed3;Leaf Motion Speed;53;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1473;-112,-3360;Half;False;Property;_LEAFMOTIONN;[ LEAF MOTIONN ];50;0;Create;True;0;0;False;1;BCategory(Leaf Motion);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1472;-1280,-3456;Half;False;Property;_ADSStandardLitTreeBark;< ADS Standard Lit Tree Bark>;1;0;Create;True;0;0;True;1;BBanner(ADS Standard Lit, Tree Bark);1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1723;-1280,-3168;Half;False;Property;_TrunkMotionParameters;!!! Trunk Motion Parameters !!!;39;0;Create;True;0;0;True;1;BMessage(Info, The Trunk Motion Parameters will be overridden by the ADS Materials Helper Component, _Internal_SetByScript, 1, 0, 10);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1513;-928,-3360;Half;False;Property;_BASEE;[ BASEE ];17;0;Create;True;0;0;True;1;BCategory(Base);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1716;2624,1920;Float;False;Property;_MotionAmplitude3;Leaf Motion Amplitude;52;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1221;-512,-1664;Float;False;1220;Motion_Output;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;1930;1168,-2688;Half;False;Property;_Internal_DebugMask;Internal_DebugMask;81;1;[HideInInspector];Create;True;0;0;True;0;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2140;2624,2432;Float;False;Property;_MotionVertical3;Leaf Motion Vertical;56;0;Create;False;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1724;-672,-3168;Half;False;Property;_LeafMtionParameters;!!! Leaf Mtion Parameters !!!;51;0;Create;True;0;0;False;1;BMessage(Info, The Leaf Motion Parameters will be overridden by the ADS Materials Helper Component, _Internal_SetByScript, 1, 0, 10);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;925;-960,-2688;Half;False;Property;_ZWrite;_ZWrite;87;1;[HideInInspector];Create;True;2;Off;0;On;1;0;False;0;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1470;-576,-3360;Half;False;Property;_TRUNKMOTIONN;[ TRUNK MOTIONN ];38;0;Create;True;0;0;True;1;BCategory(Trunk Motion);0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1688;-352,-3360;Half;False;Property;_BRANCHMOTIONN;[ BRANCH MOTIONN ];43;0;Create;True;0;0;True;1;BCategory(Branch Motion);0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-128,-2176;Float;False;True;2;Float;ADSShaderGUI;300;0;Standard;BOXOPHOBIC/Advanced Dynamic Shaders/Standard Lit/Tree Bark;False;False;False;False;False;True;True;True;True;False;True;False;False;True;True;False;True;False;False;False;True;Back;0;False;925;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0;True;True;0;True;Opaque;;Geometry;All;True;True;True;False;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;True;550;10;True;553;0;1;False;550;10;False;553;0;True;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;300;Utils/ADS Fallback;-1;-1;-1;-1;0;False;0;0;False;743;-1;0;True;862;3;Include;../../../Utils/CGIncludes/VS_indirect.cginc;False;;Pragma;instancing_options procedural:setup;False;;Pragma;multi_compile GPU_FRUSTUM_ON __;False;;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.CommentaryNode;1937;0,-2816;Float;False;2151.312;100;Internal Only;0;;1,0,0,1;0;0
...
ASEEND*/
//CHKSM=5676F9086FA8D197BE2064A90A8C4C8C9E531539