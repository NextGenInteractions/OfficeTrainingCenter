...
public class EnviroSky : EnviroCore 
{
    ...
    #region Var
    public string prefabVersion = "2.1.3";
    ...
    [HideInInspector]public bool useFog = true;
    ...
    [HideInInspector]public bool useAurora = false;
    ...
    [HideInInspector]public EnviroVolumeLight additionalDirectVolumeLight;
    ...
    public void SetupSkybox()
    {
        ...
        else if (skySettings.skyboxMode == EnviroSkySettings.SkyboxModi.Default)
        {
            ...
            Texture2D aurora_layer_1 = Resources.Load("tex_enviro_aurora_layer_1") as Texture2D;
            if(aurora_layer_1 != null)
                skyMat.SetTexture("_Aurora_Layer_1", aurora_layer_1);

            Texture2D aurora_layer_2 = Resources.Load("tex_enviro_aurora_layer_2") as Texture2D;
            if (aurora_layer_2 != null)
                skyMat.SetTexture("_Aurora_Layer_2", aurora_layer_2);

            Texture2D aurora_colorshift = Resources.Load("tex_enviro_aurora_colorshift") as Texture2D;
            if (aurora_colorshift != null)
                skyMat.SetTexture("_Aurora_Colorshift", aurora_colorshift);
	...
	private void UpdateClouds (EnviroWeatherPreset i, bool withTransition)
	{
        ...
        if (useVolumeClouds)
        {                  
            cloudsConfig.coverageModBottom = Mathf.Lerp(cloudsConfig.coverageModBottom, i.cloudsConfig.coverageModBottom, speed);
            cloudsConfig.coverageModTop = Mathf.Lerp(cloudsConfig.coverageModTop, i.cloudsConfig.coverageModTop, speed);
            ...
            cloudsConfig.densityLightning = Mathf.Lerp(cloudsConfig.densityLightning, i.cloudsConfig.densityLightning, speed);
