...
public class EnviroSkyEditor : Editor {
#if ENVIRO_HD
    private string latestVersion = "2.1.4";
	// GUI Styles
	...
	SerializedProperty Player,Camera,PlayerTag,CameraTag, AssignOnRuntime, HDR, SatTag, startMode;
    ...
    SerializedProperty cloudsHeightMod, shadowCookieSize, flatCloudsTextureIteration, flatCloudsScale, flatCloudsResolution, flatCloudsMorphingSpeed, shadowIntensity, customWeatherMap, silverLiningIntensity, silverLiningSpread, weatherAnimSpeedScale, tonemapping,globalCloudCoverage,cirrusCloudsAltitude,flatCloudsAltitude,cloudsWorldScale, hgPhase,cloudsExposure,cirrusCloudsColor,flatCloudsColor,volumeCloudsColor,volumeCloudsMoonColor,cirrusCloudsTexture,flatCloudsTexture, weatherMapTiling,LightIntensity;
    ...
    void OnEnable()
	{
		...
		reflectionUpdate = serializedObj.FindProperty ("reflectionSettings.globalReflectionsUpdateTreshhold");
			...
			if (myTarget.showSettings) {
				...
				case EnviroProfile.settingsMode.Clouds:	
					...
					GUILayout.Space (20);
                        ...
                        ///
                        GUILayout.BeginVertical("Clouds Quality", boxStyle);
                        ...
                        GUILayout.BeginVertical("Clouds Area", boxStyle);
                        GUILayout.Space(20);
                    ...
                    EditorGUILayout.EndVertical();
                        ...
                        GUILayout.BeginVertical("Wind Settings", boxStyle);
                        GUILayout.Space(20);
